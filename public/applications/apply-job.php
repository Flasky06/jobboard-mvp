...
<div class="flex">
    ...
    <div
        class="main-content-area lg:ml-[30%] lg:w-[60%] w-full mx-auto bg-white p-4 md:p-8 rounded-lg shadow-md mt-4 md:mt-8">
        <div class="mb-6">
            <h1 class="text-2xl font-bold text-gray-900 mb-2">Apply for: <?php echo htmlspecialchars($job['title']); ?>
            </h1>
        ...
        <form method="post" action="" enctype="multipart/form-data">
            ...
            <div class="mb-4 md:mb-6">
                ...
                <textarea name="cover_letter" id="cover_letter" rows="10" required
            ...
            <div class="mb-4 md:mb-6">
                <label for="resume_file" class="block text-sm font-medium text-gray-700 mb-2">Resume/CV
                    (Optional)</label>
