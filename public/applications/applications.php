...
<div class="flex">
    ...
    <div class="main-content-area lg:ml-[30%] lg:w-[60%] w-full mx-auto px-4 sm:px-6 lg:px-8 py-4">
            ...
            <div class="flex flex-wrap gap-4 items-center">
                ...
                <div>
                    ...
                    <select id="job-filter"
                        ...
                        <option value="<?php echo $job['uuid']; ?>"><?php echo htmlspecialchars($job['title']); ?>
                        </option>
                        <?php endforeach; ?>
                    </select>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-md p-6 md:p-12 text-center mobile-p-4">
            ...
            <p class="text-sm md:text-base text-gray-500 mb-4 md:mb-6">Applications will appear here once candidates
                apply
                to your jobs</p>
