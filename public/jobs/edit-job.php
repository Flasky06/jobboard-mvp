            ...
            <form action="edit-job.php?id=<?php echo $job['uuid']; ?>" method="POST">
                ...
                <div class="grid md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select name="job_level"
                            ...
                            <option value="Senior Level"
                                <?php echo ($job['job_level'] ?? '') === 'Senior Level' ? 'selected' : ''; ?>>Senior
                                Level
                            </option>
                    ...
                    <div>
                        ...
                        <select name="job_type" required
                            ...
                            <option value="full-time"
                                <?php echo ($job['job_type'] ?? '') === 'full-time' ? 'selected' : ''; ?>>Full Time
                            </option>
                            <option value="part-time"
                                <?php echo ($job['job_type'] ?? '') === 'part-time' ? 'selected' : ''; ?>>Part Time
                            </option>
                            <option value="contract"
                                <?php echo ($job['job_type'] ?? '') === 'contract' ? 'selected' : ''; ?>>Contract
                            </option>
                            <option value="freelance"
                                <?php echo ($job['job_type'] ?? '') === 'freelance' ? 'selected' : ''; ?>>Freelance
                            </option>
                        </select>
                    </div>
                    ...
                    <div>
                        ...
                        <select name="industry"
                            ...
                            <option value="Marketing"
                                <?php echo ($job['industry'] ?? '') === 'Marketing' ? 'selected' : ''; ?>>Marketing
                            </option>
                            <option value="Finance"
                                <?php echo ($job['industry'] ?? '') === 'Finance' ? 'selected' : ''; ?>>
                                Finance</option>
                            <option value="Healthcare"
                                <?php echo ($job['industry'] ?? '') === 'Healthcare' ? 'selected' : ''; ?>>Healthcare
                            </option>
                            <option value="Education"
                                <?php echo ($job['industry'] ?? '') === 'Education' ? 'selected' : ''; ?>>Education
                            </option>
                            <option value="Retail"
                                <?php echo ($job['industry'] ?? '') === 'Retail' ? 'selected' : ''; ?>>
                                Retail</option>
                            <option value="Manufacturing"
                                <?php echo ($job['industry'] ?? '') === 'Manufacturing' ? 'selected' : ''; ?>>
                                Manufacturing
                            </option>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="job_description" id="job_description" rows="10" required
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="requirements_qualifications" id="requirements_qualifications" rows="8" required
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="additional_information" id="additional_information" rows="6"
