...
<div class="flex">
    ...
    <div class="main-content-area lg:ml-[30%] lg:w-[60%] w-full mx-auto bg-white p-8 rounded-lg shadow-md mt-8">
        ...
        <form action="post-job.php" method="post" class="space-y-6" id="postJobForm">
            <?php echo csrf_field(); ?>
            ...
            <div>
                ...
                <textarea id="requirements_qualifications" name="requirements_qualifications" rows="6"
                    class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"
