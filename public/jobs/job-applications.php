...
$applications = $applicationController->getEmployerApplications($employerUuid);

// Filter applications for this specific job
$applications = array_filter($applications, function($app) use ($jobId) {
    return $app['job_uuid'] === $jobId;
});
...
<div class="flex">
    ...
    <div class="main-content-area lg:ml-[30%] lg:w-[60%] w-full mx-auto px-4 sm:px-6 lg:px-8 py-4 md:py-8">
        <!-- Header -->
        <div class="mb-8">
                ...
                <div class="bg-white rounded-lg shadow p-4">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-2xl font-bold text-blue-600"><?php echo $stats['reviewed'] ?? 0; ?></p>
                        </div>
                        <div class="w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center">
                            <svg class="w-6 h-6 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="bg-white rounded-lg shadow p-4">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-2xl font-bold text-green-600"><?php echo $stats['accepted'] ?? 0; ?></p>
                        </div>
